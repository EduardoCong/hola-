...
namespace TostiElotes.Controllers.V1
{
    ...
    public class ExtrasController : ControllerBase
    {
        ...
        private readonly ExtraService _vendedorServices;


        private readonly IMapper _mapper;

        public ExtrasController(VendedorService vendedorServices, VendedorPuestoService vendedorPuestoService, VendedoProductoService vendedoProductoService, IMapper mapper)
        {
